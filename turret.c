...
module_param(nr_missiles,uint,(S_IWUSR | S_IRUGO));
...
static struct kobj_attribute nr_missile_attr = __ATTR_RW(nr_missile,0644,NR_MISSILES_REMAINING,SET_NR_MISSILES);
