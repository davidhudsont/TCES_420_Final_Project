...
module_param(nr_missiles,uint,(S_IWUGO | S_IRUGO));
...
static struct kobj_attribute nr_missile_attr = __ATTR_RW_MISSILE(nr_missile,(S_IWUSR|S_IRUGO),NR_MISSILES_REMAINING,SET_NR_MISSILES);
