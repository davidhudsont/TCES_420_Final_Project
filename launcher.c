...
static struct kobj_attribute max_rotate_h_attr = __ATTR(rotation_h,(S_IWUSR|S_IRUGO),MAX_ROTATE_H_SHOW,MAX_ROTATE_H_SET);
static struct kobj_attribute max_rotate_v_attr = __ATTR(rotation_v,(S_IWUSR|S_IRUGO),MAX_ROTATE_V_SHOW,MAX_ROTATE_V_SET);
